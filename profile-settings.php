									...
									<div class="profile-info-widget">
										...
										<div class="profile-det-info">
											...
											<div class="patient-details">
												<h5><i class="fas fa-birthday-cake"></i><?php echo $rows['DateBirth']; ?></h5>
												<h5 class="mb-0"><i class="fas fa-map-marker-alt"></i> <?php echo $rows['city'].$rows['province']; ?></h5>
											</div>
										</div>
									</div>
								</div>
                                ...
                                <form name="pro_set" method="post" action="server.php"> //update
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label>City</label>
                                                <input type="text" name="city" class="form-control" value="<?php echo $rows['city']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label>Province</label>
                                                <input type="text" name="province" class="form-control" value="<?php echo $rows['province']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label>Zip Code</label>
                                                <input type="text" name="zipcode" class="form-control" value="<?php echo $rows['zipcode']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label>Country</label>
                                                <input type="text" name="country" class="form-control" value="<?php echo $rows['country']; ?>">
                                            </div>
                                        </div>
                                    </div>
