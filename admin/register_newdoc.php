...
<head>
    ...
    <!-- Favicons -->
    <link href="a_assets/img/favicon.png" rel="icon">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="a_assets/css/bootstrap.min.css">

    <!-- Fontawesome CSS -->
    <link rel="stylesheet" href="a_assets/plugins/fontawesome/css/fontawesome.min.css">
    <link rel="stylesheet" href="a_assets/plugins/fontawesome/css/all.min.css">
            ...
            <nav class="navbar navbar-expand-lg header-nav">
                <div class="navbar-header">
                    ...
                    <a href="index-2.html" class="navbar-brand logo">
                        <img src="a_assets/img/logo.png" class="img-fluid" alt="Logo">
                    </a>
                </div>
                        ...
                        <div class="account-content">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-7 col-lg-6 login-left">
                                    <img src="bookmia/a_assets/img/login-banner.png" class="img-fluid"
                                ...
                                <div class="col-md-12 col-lg-6 login-right">
                                    ...
                                    <!-- Register Form -->
                                    <form action="" id="RegisterForm" method="post" onsubmit="">
                                        ...
                                        <div class="form-group form-focus">
                                            <input type="text" name="name" class="form-control floating" required
                                                pattern="[a-zA-Z]+" title="Letters Only" placeholder="First Name" value=" <?php if (!empty($_POST["name"])) {
													echo $_POST["name"];
												} ?>" required>
                                            <label class="focus-label">Name</label>
                                        </div>
                                        <div class="form-group form-focus">
                                            <input type="text" name="surname" class="form-control floating" required
                                                pattern="[a-zA-Z]+" title="Letters Only" placeholder="SurName" value="<?php if (!empty($_POST["surname"])) {
													echo $_POST["surname"];
												} ?>">
                                        ...
                                        <div class="form-group form-focus">
                                            <input type="text" class="form-control floating" name="email" required
                                                ...
                                                title="Example: name@email.com" required placeholder="Email Address"
                                        ...
                                        <button class="btn btn-primary btn-block btn-lg login-btn" name="register"
