<?php 
include('assets/php/app_logic.php'); 
							...
							<div class="account-content">
								<div class="row align-items-center justify-content-center">
									...
									<?php include('messages.php'); ?>		
										...
										<form class = "forgotpws-form" action="assets/php/app_logic.php" method = "POST">
																					   <div class="form-group card-label">
														<label>Email</label>
												<input name = "forgotpws_email" type = "email" class = "form-control floating" title="Example: name@email.com" placeholder="name@email.com">
											</div>
