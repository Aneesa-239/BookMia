					...
					<ul class="nav header-navbar-rht">
						...
						<li class="nav-item dropdown has-arrow logged-item">
							<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
								<span class="user-img">
									<img class="rounded-circle" src="assets/img/patients/patient.jpg" width="31" alt="Name and Surname">
								</span>
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<div class="user-header">
									<div class="avatar avatar-sm">
										<img src="assets/img/patients/patient.jpg" alt="Doc Image" class="avatar-img rounded-circle">
									</div>
																	...
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				...
																				<a href="patient-profile.html">Name and Surname <span>Patient Code</span></a>
																			</h2>
																		</td>
																		<td>Appointmnet date<span class="d-block text-info">Time: start-end</span></td>
																	...
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				...
																				<a href="patient-profile.html">Name Surname<span>Invoice number</span></a>
																			</h2>
																		</td>
																		<td>Appointmnet date<span class="d-block text-info">Time: start-end</span></td>
