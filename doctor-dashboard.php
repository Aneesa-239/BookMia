                ...
                <div class="main-menu-wrapper">
                    ...
                    <ul class="main-nav">
                        <li class="has-submenu active">
                            ...
                            <ul class="submenu">
                                <li class="active"><a href="doctor-dashboard.html">Doctor
                                        Dashboard</a></li>
                                <li><a href="appointments.html">Appointments</a>
                                </li>
                                <li><a href="schedule-timings.html">Schedule
                                        Timing</a></li>
                                <li><a href="my-patients.html">Patients List</a>
                                </li>
                                <li><a href="doctor-profile-settings.php">Profile
                                        Settings</a></li>
                            </ul>
                        </li>
                ...
                <ul class="nav header-navbar-rht">
                    ...
                    <li class="nav-item dropdown has-arrow logged-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="doctor-profile-settings.php">Profile
                                Settings</a>
                                                        ...
                                                        <table class="table table-hover table-center mb-0">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-left">
                                                                        #INV00<?php echo $rows["InvoiceCode"] ?>
                                                                    </td>
                                ...
                                <div class="footer-widget footer-menu">
                                    ...
                                    <div class="footer-contact-info">
                                        <div class="footer-address">
                                            ...
                                            <p> 39 Sovereign Dr, Route 21 Business
                                                Park,<br> Centurion, 0178 </p>
                                        </div>
                                        <p>
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="copyright-menu">
                                            <ul class="policy-menu">
                                                <li><a href="term-condition.html">Terms
                                                        and Conditions</a></li>
                                                                ...
                                                                <h2 class="table-avatar">
                                                                    <a href="patient-profile.html"
                                                                        class="avatar avatar-sm mr-2"><img
                                                                            ...
                                                                            src="assets/img/patients/patient.jpg"
                                                                            alt="User Image"></a>
                                                                    <a href="patient-profile.html">Name and
                                                                        Surname <span>Patient
                                                                            Code</span></a>
                                                                </h2>
                                                            </td>
                                                            <td>Appointmnet date<span class="d-block text-info">Time:
                                                                    start-end</span></td>
                                                                ...
                                                                <h2 class="table-avatar">
                                                                    <a href="patient-profile.html"
                                                                        class="avatar avatar-sm mr-2"><img
                                                                            ...
                                                                            src="assets/img/patients/patient6.jpg"
                                                                            alt="User Image"></a>
                                                                    <a href="patient-profile.html">Name
                                                                        Surname<span>Invoice
                                                                            number</span></a>
                                                                </h2>
                                                            </td>
                                                            <td>Appointmnet date<span class="d-block text-info">Time:
...
>>>>>>> 36b11a167262837079990dc413f5ceaf724cce50
