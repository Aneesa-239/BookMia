...
if (isset($_POST["submit"])) {
    ...
    $query = "UPDATE User SET FirstName ='$Name', LastName= '$Surname', PhoneNumber= '$Phone', DateBirth = '$DOB', address= '$ADD', city= '$City', province='$Prov', country='$Count', zipcode='$Zip'  WHERE EmailAddress= '$authsess'";
