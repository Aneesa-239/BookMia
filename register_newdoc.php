							...
							<div class="account-content">
								<div class="row align-items-center justify-content-center">
									<div class="col-md-7 col-lg-6 login-left">
										<img src="bookmia/assets/img/login-banner.png" class="img-fluid" alt="Doccure Register">	
									</div>
										...
										<?php } ?>
											...
											<div class="form-group form-focus">
												<input type="text" name="name" class="form-control floating" 
														...
														value=" <?php if(!empty($_POST["name"])) { echo $_POST["name"]; } ?>" required>
											...
											<button class="btn btn-primary btn-block btn-lg login-btn" name = "register" type="submit">Signup</button>
											<div class="login-or">
											</div>
